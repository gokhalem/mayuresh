...
;; divide the image height by two
(define HALF-HEIGHT (/ (image-height CAT-IMAGE) 2))
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; world-stop-at-bottom: World -> Boolean
;; GIVEN: a world
;; RETURNS: a boolean 
;; EXAMPLES: see tests below
;; STRATEGY: domain knowledge
(define (world-stop-at-bottom pos)
  (if (>= pos (- CANVAS-HEIGHT HALF-HEIGHT)) true false))
...
(define (world-after-tick-helper pos paused?)
  (cond 
    [(world-stop-at-bottom pos)(make-world pos paused?)]
    [paused? (make-world pos paused?)]
    [else (make-world (+ pos CATSPEED) paused?)]))
...
(define-test-suite world-after-key-event-tests
  ...
  (check-equal?
    (world-stop-at-bottom 200) false )
