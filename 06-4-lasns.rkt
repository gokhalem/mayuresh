...
;; Returns the number of strings in the given lasn.
;; EXAMPLE: (cons "bar" (cons 23 (cons "foo" (cons 11 empty)))) => 2
;; STRATEGY: Structural Decomposition on lasn : LASN
...
;; Returns the number of strings in the given lans.
;; EXAMPLE: (cons 23 (cons "foo" (cons 11 empty)))  => 1
;; STRATEGY: Structural Decomposition on lasn : LANS
